...
namespace lve {
	...
	void LveRenderer::endFrame() {
		...
		assert(isFrameStarted && "Cant call endFrame while freame is not in progress");
		auto  commandBuffer = getCurrentCommandBuffer();
	...
	void LveRenderer::beginSwapChainRenderPass(VkCommandBuffer commandBuffer) {
		...
		assert(commandBuffer == getCurrentCommandBuffer() && "Cant begin render pass on commabd buffer from a different frame");
	...
	void LveRenderer::endSwapChainRenderPass(VkCommandBuffer commandBuffer) {
		...
		assert(commandBuffer == getCurrentCommandBuffer() && "Cant end render pass on commabd buffer from a different frame");
